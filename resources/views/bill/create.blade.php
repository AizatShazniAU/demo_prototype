        ...
        <div class="card-body bg-light">
            <div class="row gx-2">
              <div class="col-sm-6 mb-3">
                ...
                <input class="form-control" type="text"  name="payee" ><br>
              </div>
              <div class="col-sm-6 mb-3">
              ...
              <div class="col-sm-6 mb-3">
                ...
                <input value="" class="form-control datetimepicker" type="date"  name="date" ><br>
              </div>
              <div class="col-sm-6 mb-3">
                <label class="form-label" for="total">JUMLAH BIL:</label> <br>
                <input class="form-control" type="number" min="0"  name="total" ><br>
              </div>
              <div class="col-sm-12 mb-3">
                <label class="form-label" for="detail">KETERANGAN BIL:</label> <br>
                <textarea class="form-control" type="text"  name="detail" ></textarea><br>
              </div>
              <div class="col-sm-6 mb-3">
