                ...
                {{-- <div class="search-box" data-list='{"valueNames":["title"]}'>
                  ...
                  <div class="dropdown-menu border font-base start-0 mt-2 py-0 overflow-hidden w-100">
                    <div class="scrollbar list py-3" style="max-height: 24rem;">
                      ...
                      <hr class="bg-200" />
                      <h6 class="dropdown-header fw-medium text-uppercase px-card fs--2 pt-0 pb-2">Members</h6><a class="dropdown-item px-card py-2" href="{{ asset("/pages/user/profile.html") }}">
                        <div class="d-flex align-items-center">
                      ...
                      <a class="dropdown-item px-card py-2" href="{{ asset("/pages/user/profile.html") }}">
                        <div class="d-flex align-items-center">
