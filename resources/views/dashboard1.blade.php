            ...
            <div class="card-header pb-0">
              <div class="row flex-between-center g-card">
                ...
                <div class="col-auto d-flex">
                  ...
                  <div class="btn btn-sm btn-text d-flex align-items-center p-0 shadow-none" id="echart-bar-report-for-this-week-option-2"><span class="fas fa-circle text-300 fs--2 me-1"></span><span class="text">Minggu Lepas</span></div>
                </div>
              </div>
            </div>
