...
@section('content')     
  ...
  <form method="POST" action="/sysCon/">
    @csrf
        ...
        <div class="card-body bg-light">
            <div class="row gx-2">
              <div class="col-sm-6 mb-3">
                ...
                <input class="form-control" type="text"  name="conType" ><br>
              </div>         
              <div class="col-sm-6 mb-3">
                <label class="form-label" for="codeApp">KOD APPLIKASI:</label> <br>
                <input class="form-control" type="text"  name="codeApp" ><br>
              </div>
              <div class="col-sm-6 mb-3">
                <label class="form-label" for="linCh">CAS PERLESENAN:</label> <br>
                <input class="form-control" type="number" min="0" name="linCh" ><br>
              </div>
              <div class="col-sm-6 mb-3">
                <label class="form-label" for="userAcc">AKAUN PENGGUNA:</label> <br>
                <input class="form-control" type="text"  name="userAcc" ><br>
              </div>
            </div>
        </div>
      </div>
