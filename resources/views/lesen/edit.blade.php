...
@section('content')     
  ...
  <form method="POST" action="/lesen/{{ $lesen->id }}">
    @method('PUT')
    @csrf
        ...
        <div class="card-body bg-light">
            <div class="row gx-2">
              ...
              <div class="col-sm-6 mb-3">
                ...
                <input value="{{ $lesen->appName }}" class="form-control" type="text"  name="appName" ><br>
              </div>
              <div class="col-sm-6 mb-3">
                <label class="form-label" for="busName">NAMA SYARIKAT:</label> <br>
                <input value="{{ $lesen->busName }}" class="form-control" type="text"  name="busName" ><br>
              </div>
              ...
              <div class="col-sm-6 mb-3">
                ...
                <select class="form-select" name="licType" >
                  <option value="{{ $lesen->licType }}" selected>{{ $lesen->licType }}</option>
              ...
              <div class="col-sm-6 mb-3">
                ...
                <select class="form-select" name="appType" >
                  <option value="{{ $lesen->appType }}" selected>{{ $lesen->appType }}</option>
              ...
              <div class="col-sm-6 mb-3">
                ...
                <select class="form-select" name="status" >
                  <option value="{{ $lesen->status }}">{{ $lesen->status }}</option>
