        ...
        <div class="card">
          <div class="card-header pb-0">
            <div class="row flex-between-center g-card">
              <div class="col-auto">
                <h6>Laporan Kerosakan Minggu Ini</h6>
              </div>
              <div class="col-auto d-flex">
                <div class="btn btn-sm btn-text d-flex align-items-center p-0 me-3 shadow-none" id="echart-bar-report-for-this-week-option-1"><span class="fas fa-circle text-primary fs--2 me-1"></span><span class="text">Kerja Selesai</span></div>
                <div class="btn btn-sm btn-text d-flex align-items-center p-0 shadow-none" id="echart-bar-report-for-this-week-option-2"><span class="fas fa-circle text-300 fs--2 me-1"></span><span class="text">Kerja Tertangguh</span></div>
              </div>
            </div>
          </div>
          ...
          <div class="card-footer bg-light p-0"><a class="btn btn-sm btn-link d-block w-100 py-2" href="#!">Lihat Laporan<span class="fas fa-chevron-right ms-1 fs--2"></span></a></div>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="card-header d-flex flex-between-center bg-light py-2">
        ...
        <div class="dropdown font-sans-serif btn-reveal-trigger">
          ...
          <div class="dropdown-menu dropdown-menu-end border py-2" aria-labelledby="dropdown-active-user-report"><a class="dropdown-item" href="#!">Lihat</a>
            ...
            <div class="dropdown-divider"></div><a class="dropdown-item" href="#!">Kongsi</a>
          </div>
        </div>
      </div>
      <div class="card-body">
  ...
  {{-- <div class="card-header">
    ...
    <div class="row align-items-center">
      ...
      <div class="col-auto text-center pe-card">
        <button><a style="color: black" href="/gerai/create"><i class="fa fa-plus-square"></i></a></button>
      </div>
    </div>
  </div> --}}
...
<div class="card mb-3 overflow-hidden">
  <div class="card-header">
    ...
    <div class="row align-items-center">
      ...
      <div class="col-auto text-center pe-card">
        <button class="btn btn-secondary me-1 mb-1"><a style="color: black" href="/laporan/create"><i class="fa fa-plus-square"></i>Tambah</a></button>
      </div>
    </div>
  </div>
...
<table class="buttonsED table table-striped border-bottom" style="text-align: center">
  ...
  <tr >
    ...
    <td><ul> {{ $laporan -> title}}</ul></td>
    <td><ul> {{ $laporan -> date}}</ul></td>
    <td><ul> {{ $laporan -> status}}</ul></td>
    <td><ul> {{ $laporan -> reportType}}</ul></td>
    <td><ul> {{ $laporan -> cat}}</ul></td>
    @can('isAdmin')
    <td>
      <button class="buttonsED btn btn-sm btn-falcon-default" ><a style="color: black" href="/laporan/{{$laporan->id}}/edit"><i class="fas fa-pen" aria-hidden="true"></i></a></button>
      {{-- <a href="/laporan/{{$laporan->id}}/edit">KEMASKINI</a> --}}
