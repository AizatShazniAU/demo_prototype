...
var events = [{
  ...
  description: "Boston Harbor Now in partnership with the Friends of Christopher Columbus Park, the Wharf District Council and the City of Boston is proud to announce the New Year's Eve Midnight Harbor Fireworks! This beloved nearly 40-year old tradition is made possible by the generous support of local waterfront organizations and businesses and the support of the City of Boston and the Office of Meior Marty Walsh.",
...
var chartCombo = function chartCombo() {
  ...
  var getOptions = function getOptions() {
    return {
      type: 'bar',
      data: {
        labels: ['Januari', 'Februari', 'Mac', 'April', 'Mei', 'Jun', 'Julai'],
        datasets: [{
          type: 'line',
          label: 'Dataset 1',
...
var reportForThisWeekInit = function reportForThisWeekInit() {
  ...
  if ($echartBarReportForThisWeek) {
    ...
    var data = [['product', 'Kerja Selesai', 'Kerja Tertangguh'], ['Ahad', 43, 85], ['Isnin', 83, 73], ['Selasa', 86, 62], ['Rabu', 72, 53], ['Khamis', 80, 50], ['Jumaat', 50, 70], ['Sabtu', 80, 90]];
